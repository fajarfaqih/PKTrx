class fDonaturKorporat :
    ...
    def FormShow(self, mode) :
       self.Fields = ((self.uipData.ID),('DonorName','AddressStreet','AddressKelurahan','AddressSubDistrict',
          ...
          'PhoneNumber2','Email','Fax','ReferenceBy','Corporation','NPWP','SIUPP',
          'TDP','LocationType','OwnerType','EconomicSector'
               ))
       self.FieldInit = ('mode','ID','IdentityType','Corporation')
       self.ValueInit = (mode,self.uipData.ID,'P')
