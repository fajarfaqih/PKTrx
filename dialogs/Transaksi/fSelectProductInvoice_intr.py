...
class fSelectProductInvoice:
  ...
  def GetProgram(self,BranchCode,SponsorId):
    uipFilter = self.uipFilter
    uipFilter.Edit()
    uipFilter.BranchCode = BranchCode
    uipFilter.SponsorId = SponsorId
    self.DisplayProgram()
    return self.FormContainer.Show()
  ...
  def DisplayProgram(self):
    ...
    qProgram.SetParameter('BranchCode', self.uipFilter.BranchCode)
