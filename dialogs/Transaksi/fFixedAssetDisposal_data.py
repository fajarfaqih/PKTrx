...
def SimpanData(config, params, returns):
  ...
  try :
    ...
    request['AssetAccountNo'] = oTransaction.GetFieldByName('LFixedAsset.AccountNo')
    request['CashAccountNo'] = oTransaction.GetFieldByName('LCashAccount.AccountNo')
    request['Amount'] = oTransaction.Amount
    request['AssetValue'] = oTransaction.AssetValue
    ...
    response = oService.Disposal(config,sRequest,params)
