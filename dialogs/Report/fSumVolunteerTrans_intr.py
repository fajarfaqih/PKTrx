class fSumVolunteerTrans:
  ...
  def PrintExcelClick(self,sender) :
    ...
    ph = self.FormObject.CallServerMethod("SummaryVolunteer", param)
    ...
    workbook = self.oPrint.OpenExcelTemplate(self.app,'tplSumVolunteerTrans.xls')
    ...
    try:
      ...
      while i < ds.RecordCount:
        ...
        workbook.SetCellValue(row, 1, rec.IdMitra)
        workbook.SetCellValue(row, 2, rec.NamaMitra)
